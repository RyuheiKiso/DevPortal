...
// LoggerProvider テストでは Platform 依存はないが、Provider 経路で react-native のモジュール解決が発生する可能性に備えてモック
...
// LoggerProvider (RN) のテストスイート
describe("LoggerProvider (react-native)", () => {
